...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "bd3fa9f3c4f454102e4193b73be9008c";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeCityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myIntent = new Intent(WeatherController.this,ChangeLayout.class);
...
// TODO: Add letsDoSomeNetworking(RequestParams params) here:
    private void letsDoSomeNewtworking(RequestParams params){
        AsyncHttpClient client = new AsyncHttpClient();
        client.get(WEATHER_URL, params, new JsonHttpResponseHandler(){
            @Override
            public void onSuccess(int statusCode, Header[] header, JSONObject response){
                Log.d("Clima", "Result " + response.toString());
            ...
            public void onFailure(int statusCode, Header[] header, Throwable e, JSONObject response){
                ...
                Log.d("Clima","Failure " + statusCode);
